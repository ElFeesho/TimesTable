...
public class Question implements Parcelable
{
	...
	/**
	 * Must provide the question and the times table to construct the object,
	 * e.g. question × table
	 */
	...
	{
		return (getQuestion() * getTable());
	}

	/**
	 * Parcelable constructor, calls private function to serialise data back
	...
	public boolean equals(Object o)
	{
		...
		{
			Question rhs = (Question)o;
			return rhs.m_question == m_question && rhs.m_table == m_table;
		}
		return false;
	}
